...
<span style="colour:red">Crawl through Wayback Machine CDX API endpoints + from all possible subdomains:<span>
...
Advanced crawl with filtering for different file extentions + from all possible subdomains:
...
Search for confidantial information in PDF:
...
You can find different endpoints, subdomains and etc etc:
